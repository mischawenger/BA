...
\thesistitle{Indoor positioning} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Jose \textsc{Carrera} and Zhongliang \textsc{Zhao}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
